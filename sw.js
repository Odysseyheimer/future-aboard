...
var DATA_URLS = [
  ...
  "./data/stories.json", "./data/structure.json", "./data/campaign_landing.json", "./data/campaign_detective.json", "./data/campaign_fantasy.json", "./data/formal.json"
];
